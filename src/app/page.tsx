  ...
  const filtered = useMemo(() => {
    ...
    if (filters.types.length) {
      if (filters.typeMode === "and") {
        ...
        list = list.filter((p) =>
          filters.types.some((t) => p.types.includes(t))
        );
      }
    }
  ...
  return (
    <div className="app-root">
      ...
      <header className="header">
        <div className="header-inner">
          ...
          <div className="header-actions">
            ...
            {([
              { id: "list",   label: "Dex",    icon: "/icon-dex.png"    },
              { id: "team",   label: "Team",   icon: "/icon-team.png"   },
              { id: "items",  label: "Items",  icon: "/icon-items.png"  },
              { id: "biomes", label: "Biomes", icon: "/icon-biomes.png" },
      ...
      {view === "biomes" ? (
        ...
        <>
          {/* Mobile filter bar */}
          <div className="filter-mobile-wrap">
            <FilterBar filters={filters} onChange={setFilters} lang={lang} mobileOnly />
          </div>
          ...
          <div className="page-layout">
            ...
            <div className="filter-sidebar-wrap">
              <FilterBar filters={filters} onChange={setFilters} lang={lang} desktopOnly />
            </div>
